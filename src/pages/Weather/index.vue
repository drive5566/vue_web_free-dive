...
export default {
    ...
    async mounted() {
        this.getTime(),
        await axios.get(`https://opendata.cwa.gov.tw/api/v1/rest/datastore/O-B0075-001?Authorization=CWA-76104C75-092E-4A57-977B-E26C7CB2E181&StationID=46694A&WeatherElement=WaveHeight,WaveDirectionDescription,PrimaryAnemometer
&DataTime=${this.RealTime}`)
            .then((response) => {
