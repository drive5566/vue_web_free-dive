...
export default {
    ...
    async mounted() {
        this.getTime(),
        await axios.get(`https://opendata.cwa.gov.tw/api/v1/rest/datastore/O-B0075-001?Authorization=CWB-C3C5CC0C-4772-40C5-8FC3-2E23656ACF12&StationID=46694A&WeatherElement=WaveHeight,WaveDirectionDescription,PrimaryAnemometer&DataTime=${this.RealTime}`)
            .then((response) => {
